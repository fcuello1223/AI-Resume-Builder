  ...
  const templates = [
    {
      ...
      name: "Classic",
      preview:
        "A clean, traditional, resumé format with clear sections and professional typography",
    },
    {
      id: "modern",
      name: "Modern",
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 rounded-lg text-sm text-blue-600 bg-linear-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2"
      >
