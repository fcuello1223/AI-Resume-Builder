...
const Features = () => {
  ...
  return (
    ...
    >
      ...
      <Title title="Build your Resumé" description="Our Streamlined Process Helps You Create a Professional Resumé in Minutes with Intelligent AI-Powered Tools and Features" />
